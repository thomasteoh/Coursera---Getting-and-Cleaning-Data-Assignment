setwd("/media/sf_Dropbox/Technology/R/coursera/3 Getting and Cleaning Data/assignment/")
...
# Putting them into data frames and combining them
...
# Add column names and convert them to valid characters for dplyr
...
# Selecting which columns have relevant information (subject, label, mean, std) and don't contain other information (freq, angle)
...
# Calculate averages and write to a new file
